...
\begin{align}
	...
	\label{delta N}
\end{align}
Da $\ln (N_0 (1-e^{-\lambda \Delta t}))$ konstant ist, ist \eqref{delta N} eine lineare Funktion, aus der die Zerfallskonstante $\lambda$ gut abgelesen werden kann.\\
...
\begin{figure}[h]
	\includegraphics{pics/Indium.pdf}
...
\begin{figure}[h]
	\includegraphics{pics/Rhodium.pdf}
