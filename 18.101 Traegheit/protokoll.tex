...
Wird nun $T^2$ gegen $a^2$ aufgetragen, so ergibt sich eine Gerade f(x)= mx+b, mit:
\begin{figure}[htbp]
...
Durch Aufsummieren aller Teilträgheiten I, ergibt sich das Trägheitsmoment der Puppe:
\begin{align*}
I_{Pos 1}= 7,86
