...
mittlere kinetische Energie von $\frac{1}{2}$ kT besitzt, wenn es im thermischen Gleichgewicht mit seiner Umgebung ist. Damit folgt für die mittlere innere Energie pro Freiheitsgrad:
\begin{align*}
...
Zunächst muss die Wärmekapazität des Mischkaloriemeters $c_gm_g$ bestimmt werden. Dazu mischt man zwei Wassermengen der Masse $m_x, m_y$ und Temperatur $T_x, T_y$ und erhält nach Anpassung der Formel \eqref{eq_ck}:
\begin{align}
