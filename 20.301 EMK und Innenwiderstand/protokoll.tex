...
b &= U_{0, Rechteck} &= (0.0700  \pm 0.0002) V
\end{align*}
...
\begin{figure}[htbp]
\includegraphics[width=0.8\textwidth]{pics/leistung_wid.jpeg}
\caption{Leistung gegen Widerstand aufgetragen - Regressionsfunktion vom Typ $f(x)=\frac{a}{(x+b)^2}+c$ wurde verwendet}
\end{figure}
...
Dem Verlauf der Leistungs-Messwerte nach, war die Auswertung hinreichend genau. Nur im Bereich um 14 $\Omega$ gibt es eine Unerwartete Abweichung der Werte nach oben, die auf einen nichtsystematischen Fehler oder eine Messungenauigkeit schließen lässt. Ansonsten stimmen die Messwerte und der Graph sehr gut überein.
% ========================================
