...
\ref{tab_fouriertrafo} aufgeführt. 

\begin{table}[H]
 \begin{tabular}{l|c|r|c|c}
&	$n$&	$A_\text{mess}$	&$\ln n$	&$\ln A_\text{mess}$ \\
\hline
Rechteck	&1&	4280,0&	0,0&	8,4\\
&	3&	1400,0&	1,1&	7,2\\
&	5&	912,0&	1,6&	6,8\\
&	7&	592,0&	1,9&	6,4\\
&	9&	452,0&	2,2&	6,1\\
...
\end{table}
Zur Auswertung der Genauigkeit der Messung wird der Messwert $A_{\text{mess}}$ gegen die Ordnung $n$ aufgetragen und mittels GNUplot entsprechend
der Geradengleichung 
\begin{align}
 \ln A_\text{mess}=m \cdot \ln (n) +t
 \label{eq_geradex}
\end{align}
...
\begin{figure}[H]
 ...
 \begin{align}
 m_{\text{Rechteck}} = -1,001 \pm 0,021 \hspace{2cm} t_{\text{Rechteck}} = 8,37 \pm 0,05
\end{align}
\end{figure}
\begin{figure}[H]
 ...
 \begin{align}
 m_{\text{Sägezahn}} = -1.004 \pm 0,022 \hspace{2cm} t_{\text{Sägezahn}} = 7,49 \pm 0,04
\end{align}
\end{figure}
\begin{figure}[H]
...
\end{figure}
\begin{align}
 m_{\text{Dreieck}} = -2,027 \pm 0,051 \hspace{2cm} t_{\text{Dreieck}} = 7,74 \pm 0,09
\end{align}
...
\hline
Rechteck&	-1,001&	-1&	0,1\\
Sägezahn&	-1,004&	-1&	0,4\\
Dreieck&	-2,027&	-2&	1,4
 \end{tabular}
...
Lösung liefert. Jedoch sind die kleinen Fehler aussagekräftig für ein gelungenes Experiment.
