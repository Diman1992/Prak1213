...
1000	&841			&2.29\\ \hline
\end{tabular}
\captionof{table}{\mbox{Energien in 2,9~cm}}
\end{minipage}
\hspace{3cm}
\begin{minipage}[t]{0.3\textwidth}
\begin{tabular}{|c|c|c|}
...
900	&692			&2.10\\ \hline
\end{tabular}
\captionof{table}{\mbox{Energien in 3,1~cm}}
\end{minipage}
...
Um die entsprechende Energie zu erhalten, wird dieser Wert in die umgestellte Gleichung \eqref{eq_reichweite_empirisch} eingesetzt. 
